...
export const metadata: Metadata = {
  title: "为什么选择 lawGEO — 与 aceflow 等竞品对比",
  description: "lawGEO 与 aceflow / 通用 GEO 工具的核心差异：律所深度定制、12 平台覆盖、内置合规审查、免费工具开放。",
  alternates: { canonical: "/why" },
};

const compareRows = [
  { feature: "律所深度定制", us: "内置 200+ 案由词库 + 70+ 城市矩阵", others: "无，仅通用关键词工具" },
  { feature: "AI 平台覆盖", us: "12 个（8 国内 + 4 海外）", others: "6 个（仅国内）" },
  { feature: "合规审查", us: "内置律师广告法审查模板", others: "需手动审查" },
...
export default function WhyPage() {
  return (
    <>
      <JsonLd data={breadcrumbSchema([{ name: "首页", path: "/" }, { name: "为什么选 lawGEO", path: "/why" }])} />
      <PageHero
        badge="对比与选择"
        title={<>为什么律所更应该<span className="gradient-text">选 lawGEO</span></>}
        description="对比通用 GEO 平台、对比 aceflow，差异不只是「针对律所」四个字。"
      />
            ...
            <thead className="bg-slate-50 dark:bg-slate-900">
              <tr>
                ...
                <th className="px-4 py-3 text-left font-medium">
                  <Badge variant="primary">lawGEO</Badge>
                </th>
