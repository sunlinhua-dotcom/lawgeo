...
export const metadata: Metadata = {
  title: "常见问题 — GEO / BrandGEO 完整 FAQ",
  description: "什么是 GEO？GEO 与 SEO 的区别？品牌做 GEO 多久见效？BrandGEO 如何收费？数据安全如何保障？这里是完整答案。",
...
const sections: Array<{ title: string; faqs: Array<{ q: string; a: string }> }> = [
  {
    ...
    faqs: [
      {
        q: "什么是 GEO（生成式引擎优化）？",
        a: "GEO 是 Generative Engine Optimization 的缩写。它的目标不是让你的网站在 Google/Baidu 搜索结果中排名靠前，而是让你的内容成为大模型（DeepSeek、Claude、文心、通义等）生成回答时优先引用的事实源。当用户问 AI「敏感肌精华液哪个好用」时，让 AI 推荐的第一个品牌是你。",
      },
      {
        q: "GEO 与传统 SEO 的区别？",
      ...
      {
        q: "GEO 多久能看到效果？",
        a: "实时检索层（Perplexity / Kimi 联网 / 文心一言搜索）：1–3 周可见引用变化。模型训练层（Claude / GPT / DeepSeek 等纯参数模型）：3–6 个月持续沉淀。美妆品牌客户平均 6 周内首条来自 AI 推荐的主动咨询或下单。",
      },
      {
  ...
  {
    title: "关于 BrandGEO 产品",
    faqs: [
      {
        q: "BrandGEO 适合哪些行业？",
        a: "旗舰行业是美妆个护与消费品牌（内置品类词库 + 化妆品广告合规审查模板）。同时覆盖零售连锁、专业服务（财税、咨询、知产、法律）、B2B 制造与企业服务、本地生活与教育培训。",
      },
      {
        q: "BrandGEO 与 aceflow 等竞品有什么区别？",
        a: "三个核心差异：(1) BrandGEO 针对美妆个护深度定制，内置 200+ 品类 × 70+ 场景预生成关键词矩阵，aceflow 无此能力；(2) 监测平台数量 BrandGEO 12 个（含 4 个海外），aceflow 仅 6 个国内；(3) 内置化妆品广告合规审查模板，规避《广告法》《化妆品监督管理条例》对功效宣称、绝对化用语的红线。",
      },
      {
        q: "底层 AI 模型用什么？",
        a: "BrandGEO 的 AI 内容生成与多平台引用监测统一使用小米 MIMO 2.5 Pro（兼容 OpenAI 协议），并对每个平台做风格 persona 模拟。这样既能保持低成本，又能在同一基线下做引用对比。",
      },
      {
        q: "支持私有化部署吗？",
  ...
  },
  {
    title: "关于合规与安全",
    faqs: [
      { q: "化妆品广告合规如何保证？", a: "AI 生成内容默认通过合规审查模板，规避「最」「第一」「100%」等绝对化用语、医疗功效宣称（如「祛斑」「治疗」「速效」）、虚假承诺与贬损同行的表达等。法律、金融等行业另有对应的合规模板。" },
...
export default function FaqPage() {
  return (
    <>
      ...
      <PageHero
        badge="完整问答"
        title={<>关于 GEO 与 BrandGEO 的<span className="gradient-text">所有问题</span></>}
