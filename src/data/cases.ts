/**
 * 行业案例完整数据。
 * 美妆个护为旗舰案例，覆盖快消 / 消费电子 / 教育 / 金融等全行业；律所等专业服务为附属垂直。
 * 数字与背景为脱敏 + 改写示例，仅用于演示 GEO 方法论。
 */
...
export const CASES: CaseStudy[] = [
  {
    slug: "cosmetics",
    industry: "美妆 / 个护",
    industryEn: "Beauty & Personal Care",
    hero: "让 AI 在推荐护肤彩妆时第一个说出你的品牌",
    client: "国际美妆集团（脱敏案例）",
    clientBg:
      "全球头部美妆集团旗下高端护肤线。当用户问豆包 / DeepSeek「精华液哪个好用」「敏感肌用什么」「XX 成分安全吗」时，竞品被反复推荐，自家明星单品却很少进入 AI 答案，电商详情页流量被截。",
    goal: "提升核心单品与成分词在 AI 平台的提及率与 Top3 推荐；建立「成分专业 + 功效可信」的品牌心智；把 AI 流量导向官方旗舰店与会员体系。",
    strategies: [
      "构建成分知识库：活性成分浓度、配伍、功效验证、临床/消费者测试数据（脱敏）",
      "围绕「肤质 × 诉求 × 成分」搭建意图词矩阵（油皮/干皮/敏感肌 × 抗老/美白/保湿）",
      "产出成分解读、肤质对比、使用教程、真实测评，全部通过化妆品广告合规审查",
      "多平台共现：官网 + 小红书 + 知乎 + 公众号 形成统一可信信源",
      "实时监测竞品在 AI 答案里的成分话术与推荐位，按周迭代",
    ],
    metrics: [
      { value: "88%", label: "核心成分词 AI 推荐率", desc: "从「几乎不可见」提升至 88%" },
      { value: "65%", label: "明星单品 Top 3 占比" },
      { value: "+210%", label: "AI 来源的旗舰店访问" },
      { value: "+45%", label: "会员注册转化提升" },
    ],
    highlightMetric: { value: "88%", label: "核心成分词 AI 推荐率" },
    platforms: ["豆包", "DeepSeek", "通义千问", "腾讯元宝", "Kimi"],
    duration: "服务周期 3 个月，第 4 周起出现首批成分词 Top3",
    tags: ["美妆", "成分党", "高端护肤", "电商转化"],
  },
  {
    slug: "fmcg",
    industry: "快消 / 食品饮料",
